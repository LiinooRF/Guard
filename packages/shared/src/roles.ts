...
// El catalogo de permisos y la matriz rol x permiso viven en ./permissions.
// Aqui quedaron dos implementaciones paralelas tras integrar #120 y #148;
// se unificaron en permissions.ts, que es la que consumen los guards.
